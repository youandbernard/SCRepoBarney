...
@Component({
  selector: 'app-procedure-search-survey',
  templateUrl: './procedure-search-survey.component.html',
  styleUrls: ['./procedure-search-survey.component.less']
})
export class SurveyProcedureSearchComponent extends AppComponentBase implements OnInit {
  @Input() id: number;

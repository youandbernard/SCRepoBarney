var abp = abp || {};
var AbpSwagger = (function () {
    function _init(environment = "") {
        /* Swagger */
        ...
        function loginUserInternal(tenantId, callback) {
            ...
            xhr.open('POST', environment + '/api/TokenAuth/Authenticate', true);
        ...
        abp.swagger.login = function (callback) {
            ...
            if (tenancyName) {
                ...
                xhrTenancyName.open('POST', environment + '/api/services/app/Account/IsTenantAvailable', true);

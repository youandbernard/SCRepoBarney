...
namespace SnomedApi.Models
{
    ...
    public partial class Branch
    {
        ...
        public Branch(System.DateTime? baseProperty = default(System.DateTime?), long? baseTimestamp = default(long?), bool? containsContent = default(bool?), System.DateTime? creation = default(System.DateTime?), long? creationTimestamp = default(long?), System.DateTime? end = default(System.DateTime?), System.DateTime? head = default(System.DateTime?), long? headTimestamp = default(long?), System.DateTime? lastPromotion = default(System.DateTime?), bool? locked = default(bool?), IDictionary<string, string> metadata = default(IDictionary<string, string>), string path = default(string), string state = default(string), IDictionary<string, int?> versionsReplacedCounts = default(IDictionary<string, int?>))
        {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "lastPromotion")]
        public System.DateTime? LastPromotion { get; set; }
